...
@Component({
	...
	selector: 'kt-policygroups-edit-dialog',
	templateUrl: './policygroup-edit.dialog.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,
	encapsulation: ViewEncapsulation.None
})
export class PolicyGroupEditDialogComponent implements OnInit, OnDestroy {
	// Public properties
	 ...
	 */
	constructor(public dialogRef: MatDialogRef<PolicyGroupEditDialogComponent>,
	...
	createForm() {
		this.policygroupForm = this.fb.group({
			groupName: [this.policygroup.groupName, Validators.compose([Validators.required, Validators.pattern('^[A-Z]+[a-z]+[_][A-Z]+[a-z]+')])],
	...
	getTitle(): string {
		if (this.policygroup.id > 0) {
			return `Edit PolicyGroup '${this.policygroup.groupName}'`;
		}
	...
	preparePolicyGroup(): PolicyGroupModel {
		...
		_policygroup.groupName = controls.groupName.value;
