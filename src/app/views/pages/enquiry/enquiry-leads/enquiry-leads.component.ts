...
@Component({
  selector: 'kt-enquiry-leads',
  templateUrl: './enquiry-leads.component.html',
  styleUrls: ['./enquiry-leads.component.scss']
})
export class EnquiryLeadsComponent implements OnInit {
  ...
  getRowData(data) {
    this.router.navigate(['/ems/enquiry-review', data]);
  }
}
