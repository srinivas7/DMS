...
const API_EMP_URL = '/dev/employeesignin';

@Injectable()
export class AuthService {
    constructor(private http: HttpClient) {}
    // Authentication/Authorization
    login(empData): Observable<User> {
        localStorage.setItem('isNew', 'true');
        return this.http.post<User>(environment.domain + API_EMP_URL, empData);
    }
     ...
     */
    public requestPassword(employeeid: string): Observable<any> {
    	return this.http.get(API_USERS_URL + '/forgot?=' + employeeid)
